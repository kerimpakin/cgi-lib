...
class MultiPart{
	...
	char *data[ARRAY_SIZE];	   /* data is being used by only by
...
MultiPart::MultiPart(){//contructor
	...
	#define BUF_SIZE 1024 //this variable buffer sizeof datacnt for pike method
...
FILE *MultiPart::getFilebyName(char *filenamef){
